...
bool Game::init()
{
    ...
    if (!pTextureAtlas)
    {
        std::cerr << "Can't find trexture atlas: " << "mapTextureAtlas" << std::endl;
        return false;
    }
    ...
    {
        std::cerr << "Can't find trexture atlas: " << "tanksTextureAtlas" << std::endl;
        return false;
    }
    ...
    m_pTank = std::make_unique<Tank>(pTanksAnimatedSprite, 0.0000001, glm::vec2(0.f, 0.f), glm::vec2(16.f, 16.f));
